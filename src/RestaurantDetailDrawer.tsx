...
class RestaurantDetailDrawer extends React.Component<RestaurantDetailDrawerProps> {
    constructor(props) {
        ...
        const emptyObj = { title: "", category: "", distance: "", description: "", link: "" };
        this.state = {
            restaurant: restaurantList.find((restaurant) => +restaurant.id === props.restaurantId) ?? emptyObj
        };
    }

    componentDidUpdate(prevProps: Readonly<RestaurantDetailDrawerProps>, prevState: Readonly<{}>, snapshot?: any): void {
        if(this.props.restaurantId !== prevProps.restaurantId) {
            ...
            const emptyObj = { title: "", category: "", distance: "", description: "", link: "" };
            this.setState ({
                restaurant: restaurantList.find((restaurant) => +restaurant.id === +this.props.restaurantId) ?? emptyObj
            });
        }
    }
